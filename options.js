...
document.getElementById('deepseek-api-key-toggle-password').addEventListener('click', function() {
  var passwordInput = document.getElementById('deepseek-api-key');
  if (passwordInput.type === 'password') {
    passwordInput.type = 'text';
  } else {
    passwordInput.type = 'password';
...
document.getElementById('save-settings').addEventListener('click', () => {
  ...
  const deepSeekApiUrl = document.getElementById('deepseek-api-url').value;
  const deepSeekApiKey = document.getElementById('deepseek-api-key').value;
  const deepSeekModelName = document.getElementById('deepseek-model-name').value;
  const deepSeekTemperature = parseFloat(document.getElementById('deepseek-temperature').value); // Convert to number
  const deepSeekMaxToken = parseInt(document.getElementById('deepseek-max-token').value);
  ...
  chrome.storage.sync.set({
    ...
    deepSeekMaxToken: deepSeekMaxToken,
...
chrome.storage.sync.get([
  ...
  document.getElementById('deepseek-api-url').value = items.deepSeekApiUrl || '';
  document.getElementById('deepseek-api-key').value = items.deepSeekApiKey || '';
  document.getElementById('deepseek-model-name').value = items.deepSeekModelName || '';
  document.getElementById('deepseek-temperature').value = items.deepSeekTemperature;
  document.getElementById('deepseek-max-token').value = items.deepSeekMaxToken;
